...
const EDIT_COPY = {
  en: { contactName: 'Contact name', proposalDate: 'Proposal date', choose: 'Choose a proposal template', launch: 'Basic Website', growth: 'Business Website', pro: 'Premium Website', editProposal: 'Edit proposal', previewProposal: 'Preview proposal', saveDraft: 'Save proposal draft', draftSaved: 'Proposal draft saved.', editableDetails: 'Editable proposal details', price: 'Price', delivery: 'Delivery', features: 'Included items — one per line', select: 'Use template', paymentOptionsTitle: 'Payment options', bankTransfer: 'Bank transfer', creditCard: 'Credit card', bit: 'Bit', payBox: 'PayBox', cash: 'Cash', check: 'Check', installments: 'Installments', installmentCount: 'Number of installments', firstPayment: 'First payment', paymentStartDate: 'Payment start date', paymentNotes: 'Payment notes and terms', paymentNotesPlaceholder: 'For example: 50% at project start and 50% on delivery', noPaymentOptions: 'No payment options selected.' },
