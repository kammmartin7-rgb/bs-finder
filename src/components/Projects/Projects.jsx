      ...
      <div className="projects-content">
        {activeTab === 'overview' && (
          <div className="projects-overview">
            ...
            <div className="projects-navigation"><button type="button" onClick={() => onOpenScreen('tasks')}>{t('openTasks')}</button><button type="button" onClick={() => onOpenScreen('bs-hunter')}>{t('openBsHunter')}</button><button type="button" onClick={() => onOpenScreen('crm')}>{t('openCrm')}</button><button type="button" onClick={() => onOpenScreen('websites')}>{t('openWebsites')}</button></div>
          </div>
        )}
