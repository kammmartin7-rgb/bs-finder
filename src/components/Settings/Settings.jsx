...
const SCREEN_LABELS = { dashboard: 'dashboard', businesses: 'businesses', projects: 'projects', crm: 'crm', tasks: 'tasks', 'websites-assets': 'websitesAssets', 'ideas-vault': 'ideasVault' }
